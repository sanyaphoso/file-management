...
// ── Mock credentials (แทนที่ด้วย API จริง) ───────────────────────────────────
const MOCK_USERS = [
    { username: 'admin', password: '1234', role: 'ผู้ดูแลระบบ', name: 'นายสมชาย ใจดี' },
    { username: 'user01', password: '1234', role: 'เจ้าหน้าที่', name: 'น.ส.ใจใส รักงาน' },
];
...
const LoginPage: React.FC = () => {
    ...
    const handleSubmit = async (values: LoginFormValues) => {
        ...
        if (user) {
            // TODO: เก็บ token จาก API จริง เช่น localStorage.setItem('token', res.token)
            // แล้วใช้ navigate('/dashboard') หรือ window.location.href = '/dashboard'
            ...
            <div style={styles.page}>
                ...
                <div style={styles.left}>
                    <div style={styles.leftInner}>
                        ...
                        <Text style={styles.leftSub}>
                            ระบบงานสารบรรณอิเล็กทรอนิกส์<br />
                        ...
                        <div style={styles.featureList}>
                            {[
                                ...
                                <div key={f} style={styles.featureItem}>
                                    <SafetyCertificateOutlined style={{ color: '#93c5fd', marginRight: 10, flexShrink: 0 }} />
                    ...
                    {/* decorative circles */}
                    <div style={{ ...styles.circle, width: 320, height: 320, top: -80, right: -80, opacity: 0.06 }} />
                    <div style={{ ...styles.circle, width: 200, height: 200, bottom: 60, left: -60, opacity: 0.08 }} />
                </div>
                ...
                <div style={styles.right}>
                    <div style={styles.formCard}>
                        ...
                        >
                            ...
                            >
                                <Input.Password
                                    ...
                                    iconRender={(visible) =>
                                        visible ? <EyeTwoTone /> : <EyeInvisibleOutlined style={{ color: '#94a3b8' }} />
                                    }
                                />
                            </Form.Item>
                            ...
                            <Form.Item style={{ marginBottom: 20 }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <Form.Item name="remember" valuePropName="checked" noStyle>
                                        <Checkbox>
                                            <Text style={{ fontSize: 13, color: '#475569' }}>จดจำการเข้าสู่ระบบ</Text>
                                        </Checkbox>
                                    </Form.Item>
                        ...
                        <Divider style={{ margin: '4px 0 20px', borderColor: '#e2e8f0' }}>
                            <Text type="secondary" style={{ fontSize: 12 }}>บัญชีทดสอบ</Text>
                        </Divider>
                        ...
                        <Text type="secondary" style={{ display: 'block', textAlign: 'center', fontSize: 12, marginTop: 24 }}>
                            © 2567 ระบบบริหารจัดการแฟ้มข้อมูล · สงวนลิขสิทธิ์
                        </Text>
                    </div>
                </div>
...
const styles: Record<string, React.CSSProperties> = {
    ...
    left: {
        flex: '0 0 44%',
        background: 'linear-gradient(150deg, #1d4ed8 0%, #1677ff 60%, #0ea5e9 100%)',
        display: 'flex',
        alignItems: 'center',
...
//             <h1>Login Page</h1>
//             <p>หน้านี้จะทำระบบ login ในขั้นต่อไป</p>
//             <button className="enter-btn" onClick={() => navigate("/files")}>
//                 เข้าสู่ระบบ
